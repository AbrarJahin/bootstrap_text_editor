...
Please read this before copying the toolbar:
                	...
                	* to create a custom toolbar with the options and functions that are good for your particular use.
...
For more info on execCommand, see
